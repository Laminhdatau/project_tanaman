            ...
            <footer class="content-footer footer bg-footer-theme">
            	<div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
            		<div class="mb-2 mb-md-0" style="color: #2E8B57;">
            			©
            			<?= date('Y') ?>
            			, Support By :
            			<a href="#" class="footer-link fw-bolder" style="color: #2E8B57;">Mafahim Gorontalo Indonesia</a>
            		</div>
            	</div>
            </footer>
            <!-- / Footer -->
            ...
            <!-- Page JS -->
			<script src="<?= base_url('public/js/ui-modals.js')?>"></script>
