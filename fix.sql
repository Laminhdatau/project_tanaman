...
CREATE TABLE `tbl_deskripsi` (
  ...
  `slug` varchar(10) COLLATE latin1_general_ci NOT NULL,
  `informasi_budidaya` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `informasi_hama` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=latin1_general_ci;
...
CREATE TABLE `tbl_tanaman` (
  ...
  `gambar_tanaman` varchar(255) CHARACTER SET utf8mb4 COLLATE latin1_general_ci DEFAULT NULL,
  `nama_tanaman` varchar(100) NOT NULL,
  `id_varietas` varchar(100) CHARACTER SET utf8mb4 COLLATE latin1_general_ci NOT NULL,
...
(2, 'Nurazizah', 'operator@operator.com', 'c4ca4238a0b923820dcc509a6f75849b', 2, '2', '1', '2023-08-16 19:51:53');
...
INSERT INTO `tbl_varietas` (`id_varietas`, `varietas`, `id_deskripsi`) VALUES
(1, 'Sirsak Bali', 2),
(2, 'Sirsak Ratu', 2),
(3, 'Spesies Capsicum', 1),
(4, 'Sirsak Lokal', 2);
...
--
ALTER TABLE `tbl_deskripsi`
  MODIFY `id_deskripsi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_tanaman`
  MODIFY `id_tanaman` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_varietas`
  MODIFY `id_varietas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
